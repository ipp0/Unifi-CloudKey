...
download provision_cloudkey.sh and docker-compose.yml on your cloudkey
    * `wget https://raw.githubusercontent.com/ipp0/Unifi-CloudKey/refs/heads/main/docker-compose.yml`
    * `wget https://raw.githubusercontent.com/ipp0/Unifi-CloudKey/refs/heads/main/provision_cloudkey.sh`
    * `chmod a+x provision_cloudkey.sh`
    * `./provision_cloudkey.sh`
    * `reboot`
